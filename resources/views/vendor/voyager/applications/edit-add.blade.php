                        ...
                        <div class="panel-body">
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="a_step" type="text" name="step" class="form-control" value="{{ $dataTypeContent->step ?? 1 }}">
                                </div>
                                ...
                                <div class="alert alert-info">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 1) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="a_phone" type="text" name="phone" class="form-control" value="{{ $dataTypeContent->phone ?? '' }}">
                                </div>
                                ...
                                @if($dataTypeContent->step >= 2)
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №2 (СМС-код)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 2) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 3)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 3) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_iin" type="text" name="loan[iin]" class="form-control" value="{{ $dataTypeContent->loan['iin'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_summa">Сумма микрокредита</label>
                                        <input id="a_summa" type="text" name="loan[summa]" class="form-control" value="{{ $dataTypeContent->loan['summa'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_deadline">Срок микрокредита</label>
                                        <input id="a_deadline" type="text" name="loan[deadline]" class="form-control" value="{{ $dataTypeContent->loan['deadline'] ?? '' }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_add_phone" type="text" name="loan[additional_phone]" class="form-control" value="{{ $dataTypeContent->loan['additional_phone'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_email">Электронная почта</label>
                                        <input id="a_email" type="email" name="loan[email]" class="form-control" value="{{ $dataTypeContent->loan['email'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_iban">Номер счета (IBAN)</label>
                                        <input id="a_iban" type="text" name="loan[iban]" class="form-control" value="{{ $dataTypeContent->loan['iban'] ?? '' }}">
                                    </div>
                                @endif
                                ...
                                @if($dataTypeContent->step >= 4)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 4) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_year" type="number" name="car[year]" class="form-control" value="{{ $dataTypeContent->car['year'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_color">Цвет</label>
                                        <input id="a_color" type="text" name="car[color]" class="form-control" value="{{ $dataTypeContent->car['color'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_number">Гос номер</label>
                                        <input id="a_number" type="text" name="car[number]" class="form-control" value="{{ $dataTypeContent->car['number'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_vin">VIN</label>
                                        <input id="a_vin" type="text" name="car[vin]" class="form-control" value="{{ $dataTypeContent->car['vin'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_tech_password">Номер свидетельства о регистрации ТС (Тех. паспорт)</label>
                                        <input id="a_tech_password" type="text" name="car[tech_password]" class="form-control" value="{{ $dataTypeContent->car['tech_password'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_tech_date">Дата выдачи свидетельства о регистрации ТС (Тех. паспорт)</label>
                                        <input id="a_tech_date" type="date" name="car[tech_date]" class="form-control" value="{{ $dataTypeContent->car['tech_date'] ?? '' }}">
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 5)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №5 (Фото документов)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 5) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="doc_images[doc_type]" id="a_document_type" class="form-control">
                                            <option value="1" @if($type == 1) selected @endif>Удостоверение личности</option>
                                    ...
                                    @if($doc_type == 2)
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input id="a_passport" required type="file" name="doc_images[passport]" accept="image/*">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input id="a_with_passport" required type="file" name="doc_images[with_passport]" accept="image/*">
                                        </div>
                                    ...
                                    @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input id="a_front_side" required type="file" name="doc_images[front_side]" accept="image/*">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input id="a_back_side" required type="file" name="doc_images[back_side]" accept="image/*">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input id="a_selfie" required type="file" name="doc_images[selfie]" accept="image/*">
                                        </div>
                                ...
                                @if($dataTypeContent->step >= 6)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 6) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_patronymic" type="text" name="client[patronymic]" class="form-control" value="{{ $dataTypeContent->client['patronymic'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_name">Имя</label>
                                        <input id="a_name" type="text" name="client[name]" class="form-control" value="{{ $dataTypeContent->client['name'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_surname">Отчество</label>
                                        <input id="a_surname" type="text" name="client[surname]" class="form-control" value="{{ $dataTypeContent->client['surname'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_birth_date">Дата рождения</label>
                                        <input id="a_birth_date" type="date" name="client[birth_date]" class="form-control" value="{{ $dataTypeContent->client['birth_date'] ?? '' }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_number_doc" type="text" name="client[number_doc]" class="form-control" value="{{ $dataTypeContent->client['number_doc'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_date_doc">Дата выдачи</label>
                                        <input id="a_date_doc" type="date" name="client[date_doc]" class="form-control" value="{{ $dataTypeContent->client['date_doc'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_date_doc2">Дата окончания</label>
                                        <input id="a_date_doc2" type="date" name="client[date_doc2]" class="form-control" value="{{ $dataTypeContent->client['date_doc2'] ?? '' }}">
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 7)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №7 (Адресные данные)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 7) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_locality" type="text" name="address[locality]" class="form-control" value="{{ $dataTypeContent->address['locality'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_street">Улица</label>
                                        <input id="a_street" type="text" name="address[street]" class="form-control" value="{{ $dataTypeContent->address['street'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_number_home">Номер дома</label>
                                        <input id="a_number_home" type="text" name="address[number_home]" class="form-control" value="{{ $dataTypeContent->address['number_home'] ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="a_apartment">Номер квартиры</label>
                                        <input id="a_apartment" type="text" name="address[apartment]" class="form-control" value="{{ $dataTypeContent->address['apartment'] ?? '' }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="a_equal_address" type="checkbox" name="address[equal_address]"
                                               @if($equal_address == 'true') checked data-on="On" @else data-off="Off" @endif
                                    ...
                                    @if($equal_address == 'false')
                                        <div class="form-group">
                                            ...
                                            <input id="a_locality2" type="text" name="address[locality2]" class="form-control" value="{{ $dataTypeContent->address['locality2'] ?? '' }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="a_street2">Улица</label>
                                            <input id="a_street2" type="text" name="address[street2]" class="form-control" value="{{ $dataTypeContent->address['street2'] ?? '' }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="a_number_home2">Номер дома</label>
                                            <input id="a_number_home2" type="text" name="address[number_home2]" class="form-control" value="{{ $dataTypeContent->address['number_home2'] ?? '' }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="a_apartment2">Номер квартиры</label>
                                            <input id="a_apartment2" type="text" name="address[apartment2]" class="form-control" value="{{ $dataTypeContent->address['apartment2'] ?? '' }}">
                                        </div>
                                    @endif
                                ...
                                @if($dataTypeContent->step >= 8)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 8) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 9)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №9 (Подписание документов)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 9) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    'hash' => $dataTypeContent->id_hash, 'type' => 'information_form'
                                ...
                                @if($dataTypeContent->step >= 10)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 10) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="ac_front_side">Удостоверение личности (Лицевая сторона)</label>
                                        @if($c_front_side)
                                        ...
                                        @endif
                                        <input id="ac_front_side" required type="file" name="car_images_1[front_side]" accept="image/*">
                                    </div>

                                    @php($c_back_side = $dataTypeContent->car_images_1['back_side'] ?? '')
                                    <div class="form-group">
                                        <label for="ac_back_side">Удостоверение личности (Оборотная сторона)</label>
                                        @if($c_back_side)
                                        ...
                                        @endif
                                        <input id="ac_back_side" required type="file" name="car_images_1[back_side]" accept="image/*">
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 11)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 11) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 12)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №12 (Фото документов авто)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 12) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto1" required type="file" name="car_images_2[auto1]" accept="image/*">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto2" required type="file" name="car_images_2[auto2]" accept="image/*">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto3" required type="file" name="car_images_2[auto3]" accept="image/*">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto4" required type="file" name="car_images_2[auto4]" accept="image/*">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto5" required type="file" name="car_images_2[auto5]" accept="image/*">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input id="a_auto6" required type="file" name="car_images_2[auto6]" accept="image/*">
                                    </div>
                                ...
                                @if($dataTypeContent->step >= 13)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №13 (Обрабатка заявки)</h4>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 13) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>

                                        @if($dataTypeContent->status == \App\Models\Application::STATUS_NEW)
                                            <button type="button" class="btn btn-warning" onclick="applicationReject(this)">Отказать</button>
                                            <button type="button" class="btn btn-success" onclick="applicationAccept(this)">Принять</button>
                                        @else
                                            @if($dataTypeContent->status == \App\Models\Application::STATUS_CONFIRMED)
                                ...
                                @if($dataTypeContent->step >= 14)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 style="font-weight: bold">Шаг №14 (СМС-код)</h4>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                @if($dataTypeContent->step >= 15)
                                    ...
                                    <div class="alert alert-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" disabled value="{{ \App\Helpers\Common::generateLink($dataTypeContent, 15) }}">
                                                <button type="button" class="btn btn-danger" onclick="copylink(this)">Скопировать ссылку</button>
                                            </div>
                                        </div>
                                    </div>
